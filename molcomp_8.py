...
def POPOPT (mode):
	...
	if (topo == ' --readtopo=true') and len(top) == 0:
		...
		exit(0)
	if mode=='rmsd-kabsch':
		option1=' --connect=false --alg=kabsch --keepenantio=false'
		option2=' --connect=false --alg=kabsch --keepenantio=false --dist=true'
		value=0.125
	elif mode=='rmsd-hungarian':
		option1=' --connect=false --alg=std --keepenantio=false'
		option2=' --connect=false --alg=std --keepenantio=false --dist=true'
		value=0.125
	elif mode=='rmsd-graph':
		option1=' --connect=true --alg=std --keepenantio=false'+topo
		option2=' --connect=true --alg=std --keepenantio=false --dist=true'+topo
		value=0.125
	elif mode=='dist':
		option1=' --connect=true --alg=std --dist=true --keepenantio=false'+topo
		option2=' --connect=true --alg=std --dist=true --keepenantio=false'+topo
		value=1.0
	elif mode=='distratio':
		option1=' --connect=true --alg=std --dist=true --distratio=true --keepenantio=false'+topo
		option2=' --connect=true --alg=std --dist=true --distratio=true --keepenantio=false'+topo
		value=1.0
